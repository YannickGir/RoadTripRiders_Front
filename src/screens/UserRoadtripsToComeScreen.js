...
function UserRoadtripsToComeScreen(props) {
  const [roadTripListOrganisate, setRoadTripListOrganisate] = useState([]);
  const [roadTripListParticipate, setRoadTripListParticipate] = useState([]);
  ...
  if (choiceList == 'admin') {
    pagecontent = (
      <View style={{ width: '100%', alignItems: 'center' }}>
        <CustomTextBackground2
          ...
          text1={'Sorties que tu as organisé'}
        />
    ...
    pagecontent = (
      <View style={{ width: '100%', flex: 1, alignItems: 'center' }}>
        <CustomTextBackground2 text1={"Sorties où tu t'es inscrit"} />
      ...
      >
        ...
        >
          <RadioButton
            ...
            onPress={() => {
              setChoiceList('admin'), setChecked('admin');
            }}
          />
        ...
        >
          <RadioButton
            value='participate'
            status={checked === 'participate' ? 'participate' : 'participate'}
            onPress={() => {
